...
description: Writing documents an agent consumes. Use when creating or editing skills, or modifying AGENTS.md / CLAUDE.md.
triggers:
- /writing-for-agents
license: MIT
metadata:
  tags: skills, authoring, agents-md, context-pointers, progressive-disclosure, predictability
  source: mattpocock/skills (productivity/writing-for-agents)
