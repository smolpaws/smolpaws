...
- [references/fastify-docs.md](references/fastify-docs.md) - Official Fastify docs highlights and links.

## Scripts

- [scripts/fastify-quickstart.ts](scripts/fastify-quickstart.ts) - Minimal Fastify server with TypeBox and inject-based test.
