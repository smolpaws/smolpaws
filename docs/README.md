...
- [`archive/compatibility-plan-progress.md`](archive/compatibility-plan-progress.md) - historical cross-repo convergence tracker preserved from the old `enyst/smolpaws` home
