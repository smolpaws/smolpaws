...
DEFAULT_PRIVATE_WRITE_ROOTS="${SMOLPAWS_HOME_DIR}/memory${PATH_DELIMITER}${SMOLPAWS_HOME_DIR}/repo-map.json"
export SMOLPAWS_ALLOWED_WRITE_ROOTS="${SMOLPAWS_ALLOWED_WRITE_ROOTS:-$HOME/repos${PATH_DELIMITER}${DEFAULT_PRIVATE_WRITE_ROOTS}}"
